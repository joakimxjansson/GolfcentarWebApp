...
namespace WebApplication4.Pages.Feed {
    public class MyFeedModel : PageModel {
        ...
        [BindProperty] public List<Post> GetPosts { get; set; } = new List<Post>();
        [BindProperty] public List<Review> GetReviews { get; set; } = new List<Review>();
        [BindProperty] public List<Comment> GetComments { get; set; } = new List<Comment>();
