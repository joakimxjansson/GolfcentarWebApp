...
public class EditOrders : PageModel {
    ...
    public async Task<IActionResult> OnPostDownloadAsync(string id) {
        ...
        using (PdfDocument document = new PdfDocument()) {
            ...
            gfx.DrawString("Kund: " + order.First().User.FirstName + " " + order.First().User.LastName, font,
                XBrushes.Black, new XPoint(70, 60));
            ...
            gfx.DrawString(
                "Totalpris: " + order.First().TotalPrice + ":- inkl moms  (" + order.First().TotalPrice / 1.25m +
                ":- exkl moms)",
